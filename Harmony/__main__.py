import sys, asyncio
import Harmony
from Harmony import BOTLOG_CHATID, HEROKU_APP, PM_LOGGER_GROUP_ID
...
LOGS = logging.getLogger("ســـورس فيجثــون")
...
try:
    LOGS.info("⌭ بـدء تنزيـل فيجثــون ⌭")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["iHarmonyi","Harmony","PPYNY","Harmonye1","Tws_Harmony","VVV5P","Harmony_Support","tepthonklaesh","VisaHarmony"]
