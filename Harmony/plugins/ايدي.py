...
################# Dev ZilZal #################
    ZThon = f'<a href="T.me/VeGaOne">ᯓ 𝗩𝗘𝗚𝗧𝗛𝗢𝗡 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗗𝗮𝘁𝗮 📟</a>'
    ZThon += f"\n<b>⋆─┄─┄─┄─┄─┄─┄─⋆</b>\n\n"
...
################# Dev ZilZal #################
    if user_id in zelzal: 
        ...
        rotbat = "العضـو 𓅫"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت فيجثــون"  
