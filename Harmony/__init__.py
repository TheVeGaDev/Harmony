...
__version__ = "3.3.3"
__license__ = "حقـوق سـورس فيجثــون"
__author__ = "فيجثــون <https://T.me/vegaone>"
__copyright__ = "𝗩𝗘𝗚𝗔𝗧𝗛𝗢𝗡 Source (C) 2024 - 2026  " + __author__

zedub.version = __version__
LOGS = logging.getLogger("فيجثــون")
bot = zedub
...
if Config.UPSTREAM_REPO == "zel":
    UPSTREAM_REPO_URL = "https://github.com/TheVeGaDev/Harmony"
else:
